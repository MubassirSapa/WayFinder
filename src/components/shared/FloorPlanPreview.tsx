...
export function FloorPlanPreview({
  ...
  return (
    <div aria-label={`${name} map preview`} className="absolute inset-0 overflow-hidden bg-muted">
      ...
      <span className="perspective-distant absolute inset-0">
        ...
        >
          {floorCount > 1 ? <MapPreviewPlate className="translate-x-2 translate-y-5" /> : null}
