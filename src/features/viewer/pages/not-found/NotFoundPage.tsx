...
export function NotFoundPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-not-found-background text-not-found-foreground">
      ...
      <div className="not-found-grid absolute inset-0 animate-[wf-grid_16s_linear_infinite] bg-size-[60px_60px] mask-[radial-gradient(110%_110%_at_75%_35%,var(--mask-opaque)_30%,transparent_80%)]" />
      <div className="not-found-vignette pointer-events-none absolute inset-0" />
...
function RadarGraphic() {
  return (
    <div className="relative size-70 sm:size-90 lg:size-110">
      ...
      <div className="not-found-sweep absolute inset-0 animate-[wf-sweep_5s_linear_infinite] rounded-full mask-[radial-gradient(circle,var(--mask-opaque)_60%,transparent_71%)]" />
