...
| Organization | Public organization landing, About, and Contact pages, shared site chrome, and visitor handoff to the venue directory | Static server components and public route links |
